...
export default function TambahPosyanduModal({ isOpen, onClose }: TambahPosyanduModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="w-full max-w-[640px] bg-white rounded-xl shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        <div className="p-8 border-b border-gray-100 relative">
          <h2 className="text-[22px] font-bold text-gray-900 mb-1">Tambah Posyandu Baru</h2>
          <p className="text-[14px] text-gray-500">Daftarkan unit Posyandu baru dan tentukan lokasi operasionalnya.</p>
        </div>
        ...
        <div className="p-8 flex flex-col gap-5">
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              <select className="w-full px-4 py-3 rounded-lg border border-gray-200 bg-white text-[15px] text-gray-700 outline-none focus:border-btn-primary focus:ring-1 focus:ring-btn-primary appearance-none">
                <option value="" disabled selected>Pilih Desa Operasional</option>
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea 
              ...
              rows={4}
              className="w-full px-4 py-3 rounded-lg border border-gray-200 bg-white text-[15px] text-gray-700 outline-none focus:border-btn-primary focus:ring-1 focus:ring-btn-primary resize-none"
            ></textarea>
            <p className="text-[13px] text-gray-500 mt-1">Sertakan detail seperti RT/RW, nama jalan, atau patokan lokasi terdekat.</p>
          </div>
        </div>
