        ...
        <div className="p-8 flex flex-col gap-5">
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-border-input/60 bg-white text-[15px] text-text-main placeholder:text-text-placeholder outline-none focus:border-btn-primary focus:ring-1 focus:ring-btn-primary"
            />
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              {/* Tambahkan defaultValue="" di sini */}
              <select
                defaultValue=""
              ...
              >
                {/* Hapus atribut 'selected' dari sini */}
