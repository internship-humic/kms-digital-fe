...
export default function BuatAkunKaderModal({
  ...
  const onSubmit = async (data: BuatAkunKaderFormValues) => {
    ...
    console.log("Akun Kader Dibuat:", data);
    reset();
    onClose();
  };
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="p-8 flex flex-col gap-8">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="flex flex-col gap-2">
                <label className="text-[14px] font-bold text-text-main">
                  Desa Penugasan <span className="text-danger">*</span>
                </label>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[14px] text-icon-muted">
                    Buat password sementara untuk kader. Mereka akan diminta
                    untuk menggantinya saat login pertama kali.
                  </p>
                </div>
              </div>
              <div className="ml-9">
