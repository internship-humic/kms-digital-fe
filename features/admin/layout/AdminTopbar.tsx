  ...
  return (
    <header className="h-[76px] bg-background border-b border-border-input/20 flex items-center justify-end px-8 shrink-0">
      <div className="flex items-center gap-5">
        <NotificationBell href="/admin/notifikasi" className="text-icon-muted hover:text-text-main transition-colors cursor-pointer w-8 h-8 flex items-center justify-center" />
