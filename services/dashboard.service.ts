      ...
      return {
        ...
        gender:
          child.gender === "MALE" || child.gender === "Laki-laki"
            ...
            : "Perempuan",
        age: ageStr.trim(),
        weight: latestMeasurement?.body_weight
          ? `${latestMeasurement.body_weight} kg`
          : "-",
        height: latestMeasurement?.body_height
          ? `${latestMeasurement.body_height} cm`
          : "-",
